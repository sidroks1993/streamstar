...
export default function BackgroundLogo({ variant = "full", className = "" }) {
  ...
  return (
    ...
    >
      {isPeek ? (
        <svg viewBox="0 0 40 40" className="w-full h-full ss-watermark-pulse" fill="none">
          <defs>
        ...
        <svg
          viewBox="0 0 40 40"
          className="ss-watermark-pulse w-auto"
          style={{ height: "min(95vh, 95vw)" }}
          fill="none"
          preserveAspectRatio="xMidYMid meet"
        >
          <defs>
            <linearGradient id="bg-ss-grad-full" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="#A855F7" />
              <stop offset="55%" stopColor="#EC4899" />
              <stop offset="100%" stopColor="#22D3EE" />
            </linearGradient>
          </defs>
          <path d="M20 2 L23 16 L38 20 L23 24 L20 38 L17 24 L2 20 L17 16 Z" fill="url(#bg-ss-grad-full)" />
          <path d="M17.5 15 L27 20 L17.5 25 Z" fill="#0A0A0A" />
          <circle cx="34" cy="8" r="1.6" fill="#22D3EE" />
        </svg>
      )}
